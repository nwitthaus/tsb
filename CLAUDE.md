...
- Run `php artisan ide-helper:models --write-mixin --no-interaction` after creating or modifying models or migrations.
- Run `php artisan ide-helper:generate --no-interaction` after adding new packages that provide facades.
